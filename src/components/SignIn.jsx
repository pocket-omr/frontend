...
export default function SignIn() {
  ...
  return (
    <>
      ...
      >
        ...
        >
          ...
          <div className="text-center mb-10">
            ...
            >
              Welcome Back to{" "}
              <span style={{ color: "#0B96D9", fontSize: "40px" }}>Q</span>
              uizor
            </h2>
            <p
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-6">
            <InputField
              ...
              placeholder="Email"
              icon={
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#053B76" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <InputField
                ...
                icon={
                  <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#053B76" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <circle cx="12" cy="16" r="1.5" fill="#053B76" strokeWidth="1" stroke="#053B76"></circle>
                    <circle cx="8" cy="16" r="1.5" fill="#053B76" strokeWidth="1" stroke="#053B76"></circle>
                    <circle cx="16" cy="16" r="1.5" fill="#053B76" strokeWidth="1" stroke="#053B76"></circle>
                  </svg>
                }
              />
            ...
            <div className="flex justify-between items-center text-sm px-1 pt-1" style={{ fontFamily: "'Segoe UI', sans-serif", color: "#053B76", fontWeight: "600" }}>
              <label className="flex items-center gap-2 cursor-pointer border-0">
                <input
                  ...
                  style={{ accentColor: "#053B76", borderRadius: "4px" }}
                />
                Remember me
              </label>
      ...
      ══════════════════════════════════════ */}
      <div
        className="signin-mobile flex-col min-h-screen w-full border-0"
        style={{
      ...
      >
        ...
        >
          <div style={{ textAlign: "center", marginBottom: 32 }}>
            ...
            >
              Welcome Back to{" "}
              <span style={{ color: "#0B96D9", fontSize: "1.9rem" }}>Q</span>
              uizor
            </h2>
            <p style={{ color: "#6B8DB2", fontFamily: "'Segoe UI', sans-serif", fontSize: "0.85rem" }}>
              Sign in to manage and evaluate exams.
            </p>
          </div>
          ...
          >
            <InputField
              ...
              mobile
              icon={
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#053B76" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path>
                  <polyline points="22,6 12,13 2,6"></polyline>
                </svg>
              }
              ...
              <InputField
                ...
                icon={
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#053B76" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect>
                    <path d="M7 11V7a5 5 0 0 1 10 0v4"></path>
                    <circle cx="12" cy="16" r="1" fill="#053B76" strokeWidth="1" stroke="#053B76"></circle>
                    <circle cx="8" cy="16" r="1" fill="#053B76" strokeWidth="1" stroke="#053B76"></circle>
                    <circle cx="16" cy="16" r="1" fill="#053B76" strokeWidth="1" stroke="#053B76"></circle>
                  </svg>
                }
              />
              <EyeToggle show={showPassword} onToggle={() => setShowPassword(!showPassword)} />
    ...
    <div style={{ position: "relative", width: "100%" }}>
      ...
      <input
        ...
        style={{
          ...
          paddingRight: extraPaddingRight ? 48 : 16,
          border: focused ? "2px solid #0B96D9" : "1px solid #053B76",
          borderRadius: 12,
          background: "#FFFFFF",
          color: "#053B76",
          fontFamily: "'Segoe UI', sans-serif",
