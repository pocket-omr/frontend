...
export default function ResetPassword() {
  ...
  return (
    <>
      ...
      <div className="rp-desktop relative min-h-screen w-full" style={{ backgroundImage: `url('${backgroundImg}')`, backgroundSize: "100% 100%", backgroundRepeat: "no-repeat", backgroundPosition: "left center" }}>
        ...
        <div className="flex flex-col justify-center" style={{ width: "55%", paddingLeft: "7%", paddingRight: "12%" }}>
          <div className="text-center mb-10">
            <h2 className="font-bold mb-3" style={{ color: "#053B76", fontFamily: "'Segoe UI', sans-serif", fontSize: "2.3rem", lineHeight: 1.2 }}>Reset Your <span style={{ color: "#0B96D9" }}>P</span>assword</h2>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-6 items-center" style={{ width: "100%", maxWidth: "450px", margin: "0 auto" }}>
